                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/laporan-penjualan" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/laporan-penjualan/filter" method="post">
                                        <div class="row">
                                            <div class="col-4">
                                    ...
                                    <br>
                                    <!-- Isi Report -->
                                    <a target="_blank" class="btn btn-primary mb-3" type="button" href="/exportpdf-penjualan">Export PDF</a>
                                    <a class="btn btn-dark mb-3" type="button" href="/exportexcel-penjualan">Export Excel</a>
