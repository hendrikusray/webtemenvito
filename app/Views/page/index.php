...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <h1>loading...</h1>
            <!-- <img class="animation__wobble" alt="AdminLTELogo" height="60" width="60"> -->
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">New Layanan</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="layananForm" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nama_produk" class="col-form-label">Nama Layanan:</label>
                                <input type="text" class="form-control" id="nama_produk" name="nama_produk">
                            </div>
                            <div class="mb-3">
                                <label for="jenis_produk" class="col-form-label">Tipa Layanan:</label>
                                <textarea class="form-control" id="jenis_produk" name="jenis_produk"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="harga_produk" class="col-form-label">Harga Layanan:</label>
                                <input type="number" class="form-control" id="harga_produk" name="harga_produk">
                            </div>
                            <div class="mb-3">
                                <label for="jumlah_stok" class="col-form-label">Stock:</label>
                            ...
                            <div class="mb-3">
                                <label for="foto" class="col-form-label">Foto Layanan</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#example1 tbody').on('click', 'a.edit-link', function() {
                ...
                $('#diskon').val(diskon);
                $('#foto-preview').attr('src', "<?= base_url('writable/uploads/' . $gambar_produk) ?>");
